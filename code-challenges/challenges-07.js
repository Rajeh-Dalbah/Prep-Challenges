...
const objLat = (obj) => {
    let {firstName, lastName, age, hobby} = obj;

  let objFirstName = firstName.charAt(0).toUpperCase() + firstName.slice(1).toLowerCase();
  let objLastName = lastName.charAt(0).toUpperCase() + lastName.slice(1).toLowerCase();
  let formattedAge = age + " YO";

  return `my name is ${objFirstName} ${objLastName} I am ${formattedAge}, and I love ${hobby}.`;
};
// -------------------------------------------------------------------------------------------------------
...
const cvFormatter = (arr) => {
    ...
    for (let i = 0; i < arr.length; i++) {
      ...
      if (cv.yearsOfExperience > 1) {
        let fullName =(cv.firstName)? cv.firstName:"";
        if (cv.lastName) {
